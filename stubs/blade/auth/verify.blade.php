            ...
            <div class="w-full max-w-sm">
                ...
                <div class="flex flex-col break-words bg-white border border-2 rounded shadow-md">
                    ...
                    <div class="w-full flex flex-wrap p-6">
                        ...
                        <a class="bg-blue hover:bg-blue-dark text-white font-semibold py-2 px-4 rounded focus:outline-none focus:shadow-outline  ml-auto" href="{{ route('verification.resend') }}">
